...
return [
     ...
     */
    'route' => [
        'success' => env('SSLC_ROUTE_SUCCESS', 'checkout.sslcommerz.success'),
        'failure' => env('SSLC_ROUTE_FAILURE', 'checkout.sslcommerz.failure'),
        'cancel' => env('SSLC_ROUTE_CANCEL', 'checkout.sslcommerz.cancel'),
        'ipn' => env('SSLC_ROUTE_IPN', 'checkout.sslcommerz.ipn'),
    ],
     ...
     */
    'localhost' => env('SSLC_ALLOW_LOCALHOST', false),
