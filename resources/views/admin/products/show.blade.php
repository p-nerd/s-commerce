<x-admin-layout>
    ...
    <x-show.card>
        ...
        <x-show.two>
            ...
            <x-show.item label="Discount Price">
                {{ $product->discount_price }}
            </x-show.item>
        </x-show.two>
        <x-show.two>
            <x-show.item label="Manufactured Date">
                {{ $product->manufactured_date }}
            </x-show.item>
            <x-show.item label="Expired Date">
        ...
        <x-show.rich-text label="Long Description">
