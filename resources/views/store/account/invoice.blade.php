...
<body class="invoice invoice-content invoice-3" style="padding-top: 0; padding-bottom: 0; background: white;">
    <div class="invoice-inner">
        <div class="invoice-info" id="invoice_wrapper" style="border-radius: 0; margin-bottom: 0;">
            <div class="invoice-header" style="padding-top: 20px; padding-bottom: 20px; border-radius: 0;">
                <div class="row" style="display: flex; justify-content: space-between; align-items: center;">
                    <div class="col-sm-6">
                        <div class="invoice-name">
                            <div class="logo">
                                <a href="{{ route('index') }}">
                                    <img src="{{ url('assets/imgs/theme/logo-light.svg') }}" alt="logo" />
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="invoice-top" style="padding-top: 20px; padding-bottom: 0px; margin-bottom: 30px;">
                <div class="row">
