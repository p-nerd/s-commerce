        ...
        <div class="page-content pt-50">
                    ...
                    <div class="col-xl-10 col-lg-12 m-auto">
                        <section class="row align-items-center mb-50">
                            ...
                            <div class="col-lg-6">
                                <div class="pl-25">
                                    ...
                                    <p class="mb-50">Ius ferri velit sanctus cu, sed at soleat accusata. Dictas prompta
                                        et Ut placerat legendos interpre.Donec vitae sapien ut libero venenatis
                                        faucibus. Nullam quis ante Etiam sit amet orci eget. Quis commodo odio aenean
                                        sed adipiscing. Turpis massa tincidunt dui ut ornare lectus. Auctor elit sed
                                        vulputate mi sit amet. Commodo consequat. Duis aute irure dolor in reprehenderit
                        ...
                        <section class="row align-items-center mb-50">
                            <div class="row mb-50 align-items-center">
                                ...
                                <div class="col-lg-5">
                                    <h4 class="text-muted mb-20">Our performance</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-4 pr-30 mb-md-5 mb-lg-0 mb-sm-5">
                                    ...
                                    <p>Volutpat diam ut venenatis tellus in metus. Nec dui nunc mattis enim ut tellus
            ...
            <section class="mb-50 d-none d-md-block container">
                <div class="row about-count">
                    <div class="col-lg-1-5 col-md-6 mb-lg-0 mb-md-5 text-center">
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-lg-0 mb-md-5 mb-sm-5">
                                    ...
                                    <p class="mb-30">Proin ullamcorper pretium orci. Donec necscele risque leo. Nam
                                        massa dolor imperdiet neccon sequata congue idsem. Maecenas malesuada faucibus
                                        finibus.</p>
                                    <p class="mb-30">Proin ullamcorper pretium orci. Donec necscele risque leo. Nam
                                        massa dolor imperdiet neccon sequata congue idsem. Maecenas malesuada faucibus
                                        finibus.</p>
