@props(['divisions', 'division', 'district'])

<div class="row">
    <div class="form-group col-lg-6">
        <label for="select-division">Select Division *</label>
        <select class="form-control" id="select-division" name="division" value="{{ old('division') ?? $division }}"
            required disabled>
    ...
    <div class="form-group col-lg-6">
        ...
        <select class="form-control" value="{{ old('district') ?? $district }}" id="select-district" name="district"
            required disabled data-divisions="{{ $divisions }}">
