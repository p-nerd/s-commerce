        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                <button id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar"
                    class="p-2 text-gray-600 rounded cursor-pointer hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:bg-gray-700 dark:focus:ring-gray-700 lg:hidden">
                ...
                <div class="flex self-center ml-2 space-x-2 text-2xl font-semibold whitespace-nowrap">
                    <a href="/">S-Commerce</a>
                    <span>/</span>
            ...
            <div class="flex items-center">
                ...
                <button id="toggleSidebarMobileSearch" type="button"
                    class="p-2 text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white lg:hidden">
                ...
                <div id="dropdownNavbar"
                    class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:divide-gray-600 dark:bg-gray-700">
                    ...
                    <div class="py-2">
                        <a href="#"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">Sign
                            out</a>
                    </div>
                </div>
                ...
                <div class="z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                    ...
                    <div>
                        <a href="#"
                            class="flex px-4 py-3 border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                            <div class="flex-shrink-0">
                                <img class="rounded-full h-11 w-11" src={asset('images/users/bonnie-green.png')}
                                    alt="Jese image" />
                                <div
                        ...
                        <a href="#"
                            class="flex px-4 py-3 border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                            <div class="flex-shrink-0">
                                <img class="rounded-full h-11 w-11" src={asset('images/users/jese-leos.png')}
                                    alt="Jese image" />
                                <div
                            ...
                            <div class="w-full pl-3">
                                <div class="mb-1.5 text-sm font-normal text-gray-500 dark:text-gray-400">
                                    <span class="font-semibold text-gray-900 dark:text-white">Jese leos</span> and <span
                        ...
                        <a href="#"
                            class="flex px-4 py-3 border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                            <div class="flex-shrink-0">
                                <img class="rounded-full h-11 w-11" src={asset('images/users/joseph-mcfall.png')}
                                    alt="Joseph image" />
                                <div
                        ...
                        <a href="#"
                            class="flex px-4 py-3 border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                            <div class="flex-shrink-0">
                                <img class="rounded-full h-11 w-11" src={asset('images/users/leslie-livingston.png')}
                                    alt="Leslie image" />
                                <div
                        ...
                        <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                            <div class="flex-shrink-0">
                                <img class="rounded-full h-11 w-11" src={asset('images/users/robert-brown.png')}
                                    alt="Robert image" />
                                <div
                ...
                <button type="button" data-dropdown-toggle="apps-dropdown"
                    class="hidden p-2 text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white sm:flex">
                    <span class="sr-only">View notifications</span>
                    <!-- Icon -->
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <div class="z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                    ...
                    <div class="grid grid-cols-3 gap-4 p-4">
                        <a href="#"
                            ...
                            <svg class="mx-auto mb-1 text-gray-500 h-7 w-7 dark:text-gray-400" fill="currentColor"
                        ...
                        <a href="#"
                            class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                            <svg class="mx-auto mb-1 text-gray-500 h-7 w-7 dark:text-gray-400" fill="none"
                ...
                <div class="flex items-center ml-3">
                    ...
                    <!-- Dropdown menu -->
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:divide-gray-600 dark:bg-gray-700"
                        id="dropdown-2">
