    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                ...
                <!-- Dropdown menu -->
                <div class="z-20 z-50 my-4 hidden max-w-sm list-none divide-y divide-gray-100 overflow-hidden rounded bg-white text-base shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                    ...
                    <div>
                        <a href="#"
                            ...
                            <div class="flex-shrink-0">
                                <img class="h-11 w-11 rounded-full" src={asset('images/users/bonnie-green.png')}
                                    alt="Jese image" />
                                <div
                        ...
                        <a href="#"
                            class="flex border-b px-4 py-3 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                            <div class="flex-shrink-0">
                                <img class="h-11 w-11 rounded-full" src={asset('images/users/jese-leos.png')}
                                    alt="Jese image" />
                                <div
                        ...
                        <a href="#"
                            class="flex border-b px-4 py-3 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                            <div class="flex-shrink-0">
                                <img class="h-11 w-11 rounded-full" src={asset('images/users/joseph-mcfall.png')}
                                    alt="Joseph image" />
                                <div
                        ...
                        <a href="#"
                            class="flex border-b px-4 py-3 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                            <div class="flex-shrink-0">
                                <img class="h-11 w-11 rounded-full" src={asset('images/users/leslie-livingston.png')}
                                    alt="Leslie image" />
                                <div
                            ...
                            <div class="w-full pl-3">
                                <div class="mb-1.5 text-sm font-normal text-gray-500 dark:text-gray-400">
                                    ...
                                    mentioned you in a comment: <span
                                        class="text-primary-700 dark:text-primary-500 font-medium">@bonnie.green</span>
                                    what do you say?
                                </div>
                                <div class="text-primary-700 dark:text-primary-400 text-xs font-medium">
                                    1 hour ago
                        ...
                        <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                            <div class="flex-shrink-0">
                                <img class="h-11 w-11 rounded-full" src={asset('images/users/robert-brown.png')}
                                    alt="Robert image" />
                                <div
                ...
                <div class="z-20 z-50 my-4 hidden max-w-sm list-none divide-y divide-gray-100 overflow-hidden rounded bg-white text-base shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                    ...
                    <div class="grid grid-cols-3 gap-4 p-4">
                        <a href="#"
                            ...
                            <svg class="mx-auto mb-1 h-7 w-7 text-gray-500 dark:text-gray-400" fill="currentColor"
                        ...
                        <a href="#"
                            class="block rounded-lg p-4 text-center hover:bg-gray-100 dark:hover:bg-gray-600">
                            <svg class="mx-auto mb-1 h-7 w-7 text-gray-500 dark:text-gray-400" fill="none"
