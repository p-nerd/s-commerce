        ...
        <form method="POST" action="{{ route('dashboard.categories.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <x-dashboard.textarea-input id="description" class="mt-1 h-[110px] w-full resize-y" name="description"
                    :value="old('description')" required autofocus autocomplete="description"></x-dashboard.textarea-input>
            ...
            <div>
                ...
                <x-dashboard.select-input id="parent-category" class="mt-1 block w-full" name="Select parent category"
                    :value="old('parent_category')" required autofocus autocomplete="parent-category" :options="$categories" />
